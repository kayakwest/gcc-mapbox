...
@town_text:         lighten(#353a3b,10);
@town_halo:         @place_halo;
@poi_text:          @poi_text;  
@road_text:         #353a3b;
@road_halo:         #fff;
@other_text:        lighten(#353a3b,20);
...
#place_label[type!='suburb'][type!='neighborhood'][type!='hamlet'][type!='village'][zoom>=8][zoom<=15][localrank<=3] {
  text-name: @name;
  text-face-name: @sans;
  text-placement: point;
  text-fill: @city_text;
